                            ...
                            <div class="table-responsive">
                                <table class="table text-center" id="user_table">
                                    ...
                                    <tr>
                                        <th scope="row">1</th>
                                        <td>Smith Doe</td>
                                        <td><img class="rounded-circle m-0 avatar-sm-table" src="{{asset("back/img/1.jpg")}}" alt="" /></td>
        ...
        <div class="col-lg-6 col-md-12">
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column flex-sm-row align-items-sm-center mb-3"><img class="avatar-lg mb-3 mb-sm-0 rounded mr-sm-3" src="{{asset("back/img/headphone-4.jpg")}}" alt="" />
                    ...
                    <div class="d-flex flex-column flex-sm-row align-items-sm-center mb-3"><img class="avatar-lg mb-3 mb-sm-0 rounded mr-sm-3" src="{{asset("back/img/headphone-2.jpg")}}" alt="" />
                        <div class="flex-grow-1">
                    ...
                    <div class="d-flex flex-column flex-sm-row align-items-sm-center mb-3"><img class="avatar-lg mb-3 mb-sm-0 rounded mr-sm-3" src="{{asset("back/img/headphone-3.jpg")}}" alt="" />
                        <div class="flex-grow-1">

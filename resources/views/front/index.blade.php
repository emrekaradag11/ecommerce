                    ...
                    <a class="flex justify-between items-center bg-gray-200 rounded-md px-5 2xl:px-3.5 py-3 xl:py-3.5 2xl:py-2.5 3xl:py-3.5 transition hover:bg-gray-100" href="">
                        <div class="flex items-center">
                            <div class="inline-flex flex-shrink-0 w-60px h-60px">
                                <img alt="{{$c->title}}" src="{{asset($c->image ? 'uploads/' . $c->image()->first()->img : "images/no_img.jpg")}}" class="bg-gray-300 object-cover rounded-full">
                            </div>
                            <h3 class="text-sm md:text-base 2xl:text-sm 3xl:text-base text-heading capitalize ps-2.5 md:ps-4 2xl:ps-3 3xl:ps-4">{{$c->title}}</h3>
                        </div>
                        <div class="flex items-center">
                        ...
                        <div class="group box-border overflow-hidden flex rounded-md cursor-pointer flex-row items-center transition-transform ease-linear bg-gray-200 pe-2 lg:pe-3 2xl:pe-4" role="button" title="Maniac Red Boys">
                            <div class="flex flex-shrink-0 w-32 sm:w-44 md:w-40 lg:w-52 2xl:w-56 3xl:w-64">
                                <div style="display: inline-block; max-width: 100%; overflow: hidden; position: relative; box-sizing: border-box; margin: 0;">
                                    ...
                                    <img alt="Maniac Red Boys" src="{{$p->getProductDetail->firstImage()}}" decoding="async" class="bg-gray-300 object-cover rounded-s-md rounded-s-md transition duration-200 ease-linear transform group-hover:scale-105" style="position: absolute; inset: 0; box-sizing: border-box; padding: 0; border: none; margin: auto; display: block; width: 0; height: 0; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%;">
                                </div>
                            </div>
                            <div class="w-full overflow-hidden ps-3.5 sm:ps-5 md:ps-4 xl:ps-5 2xl:ps-6 3xl:ps-10">
                                ...
                                <div class="text-heading font-semibold text-sm sm:text-base mt-1.5 space-s-2 sm:text-xl md:text-base lg:text-xl md:mt-2.5 2xl:mt-3">
                                    <span class="inline-block">{{$p->getProductDetail->price}}</span>
                                                ...
                                                <div class="group box-border overflow-hidden flex rounded-md cursor-pointer pe-0 md:pb-1 flex-col items-start bg-white" role="button" title="Polarised Wayfarer Sunglasses">
                                                    <div class="flex mb-3 md:mb-3.5 pb-0 false">
                                                        <div style="display: inline-block; max-width: 100%; overflow: hidden; position: relative; box-sizing: border-box; margin: 0px;">
                                                            ...
                                                            <img alt="Polarised Wayfarer Sunglasses" src="{{$f->getProductDetail->firstImage()}}" decoding="async" class="bg-gray-300 object-cover rounded-s-md rounded-md transition duration-150 ease-linear transform group-hover:scale-105" style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%;">
                                                        </div>
                                                    </div>
                                                    <div class="w-full overflow-hidden ps-0 false">
                                                        ...
                                                        <div class="text-heading font-semibold text-sm sm:text-base mt-1.5 space-s-2 sm:text-xl md:text-base lg:text-xl md:mt-2.5 2xl:mt-3"><span class="inline-block">{{$f->getProductDetail->price}}</span><del class="sm:text-base font-normal text-gray-800">$35.00</del></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div>
                    ...
                    <div class="group box-border overflow-hidden flex rounded-md cursor-pointer pe-0 pb-2 lg:pb-3 flex-col items-start bg-white transition duration-200 ease-in-out transform hover:-translate-y-1 hover:md:-translate-y-1.5 hover:shadow-product" role="button" title="Nike Black">
                        <div class="flex mb-3 md:mb-3.5">
                            <div style="display:inline-block;max-width:100%;overflow:hidden;position:relative;box-sizing:border-box;margin:0">
                                ...
                                <img alt="Nike Black" src="{{$b->getProductDetail->firstImage()}}" decoding="async" class="bg-gray-300 object-cover rounded-s-md w-full rounded-md transition duration-200 ease-in group-hover:rounded-b-none" style="position:absolute;top:0;left:0;bottom:0;right:0;box-sizing:border-box;padding:0;border:none;margin:auto;display:block;width:0;height:0;min-width:100%;max-width:100%;min-height:100%;max-height:100%"/>
                            </div>
                        </div>
                        <div class="w-full overflow-hidden ps-0 lg:ps-2.5 xl:ps-4 pe-2.5 xl:pe-4">
                            <h2 class="text-heading font-semibold truncate mb-1 text-sm md:text-base">{{$b->title}}</h2>
                            <div class="text-heading font-semibold text-sm sm:text-base mt-1.5 space-s-2 lg:text-lg lg:mt-2.5">
                                <span class="inline-block">{{$b->getProductDetail->price}}</span>
                    ...
                    <div class="group box-border overflow-hidden flex rounded-md cursor-pointer pe-0 pb-2 lg:pb-3 flex-col items-start bg-white transition duration-200 ease-in-out transform hover:-translate-y-1 hover:md:-translate-y-1.5 hover:shadow-product" role="button" title="Armani Veni Vidi Vici">
                        <div class="flex mb-3 md:mb-3.5">
                            <div style="display:inline-block;max-width:100%;overflow:hidden;position:relative;box-sizing:border-box;margin:0">
                                ...
                                <img alt="Armani Veni Vidi Vici" src="{{$n->getProductDetail->firstImage()}}" decoding="async" class="bg-gray-300 object-cover rounded-s-md w-full rounded-md transition duration-200 ease-in group-hover:rounded-b-none" style="position:absolute;top:0;left:0;bottom:0;right:0;box-sizing:border-box;padding:0;border:none;margin:auto;display:block;width:0;height:0;min-width:100%;max-width:100%;min-height:100%;max-height:100%"/>
                            </div>
                        </div>
                        <div class="w-full overflow-hidden ps-0 lg:ps-2.5 xl:ps-4 pe-2.5 xl:pe-4">
                            <h2 class="text-heading font-semibold truncate mb-1 text-sm md:text-base">{{$n->title}}</h2>
                            ...
                            <div class="text-heading font-semibold text-sm sm:text-base mt-1.5 space-s-2 lg:text-lg lg:mt-2.5">
                                <span class="inline-block">{{$n->getProductDetail->price}}</span>
                                <del class="sm:text-base font-normal text-gray-800">$20.00</del>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="relative inline-flex mb-3.5 md:mb-4 lg:mb-5 xl:mb-6 mx-auto rounded-md">
                                        <div class="flex">
                                            <div style="display: inline-block; max-width: 100%; overflow: hidden; position: relative; box-sizing: border-box; margin: 0px;">
                                                ...
                                                <img alt="Blaze Fashion" src="{{asset($t->image ? 'uploads/' . $t->image()->first()->img : "images/no_img.jpg")}}" decoding="async" class="object-cover bg-gray-300 rounded-md" style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%;">
                                            </div>
                                        </div>
                                    </div>
                                    <h4 class="text-heading text-sm md:text-base xl:text-lg font-semibold capitalize">

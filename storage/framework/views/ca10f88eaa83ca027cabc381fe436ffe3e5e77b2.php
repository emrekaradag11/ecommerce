<?php $__env->startSection("content"); ?>
    ...
    <div class="modal fade" id="categoryModal" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <form method="post" action="<?php echo e(route("admin.category.store")); ?>" enctype="multipart/form-data" class="form modal-content">
                <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="categoryEditModal" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <form method="post" action="<?php echo e(url("admin/category")); ?>" enctype="multipart/form-data" class="form modal-content">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make("back.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/emrekaradag/Desktop/projeler/desktop/LRVLPROJECT/ecommerce/resources/views/back/category/index.blade.php ENDPATH**/ ?>
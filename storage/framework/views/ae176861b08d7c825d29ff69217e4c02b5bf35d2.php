        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class=" justify-center pt-8 sm:justify-start sm:pt-0">
                    ...
                    <h1 class=""><a class="text-gray-200" href="<?php echo e(url('/admin')); ?>"> Go Back </a></h1>
                </div>
...
<?php /**PATH C:\Users\MONSTER\Desktop\LRVLPROJECT\ecommerce\resources\views/welcome.blade.php ENDPATH**/ ?>
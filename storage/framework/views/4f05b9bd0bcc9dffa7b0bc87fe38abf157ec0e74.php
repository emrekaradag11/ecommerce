...
<head>
    ...
    <link rel="preload" href="<?php echo e(asset('front/css/theme.css')); ?>" as="style"/>
    <link rel="stylesheet" href="<?php echo e(asset('front/css/theme.css')); ?>" />
    <link rel="preload" href="<?php echo e(asset('front/css/swiper.css')); ?>" as="style"/>
    <link rel="stylesheet" href="<?php echo e(asset('front/css/swiper.css')); ?>" />
                ...
                <div class="flex items-center justify-center mx-auto max-w-[1920px] h-full w-full">
                    ...
                    <a class="inline-flex focus:outline-none" href="index.html">
                        <div style="overflow:hidden;box-sizing:border-box;display:inline-block;position:relative;width:95px;height:30px">
                            <img alt="ChawkBazar" src="<?php echo e(url('images/logo.svg')); ?>" decoding="async" style="position:absolute;top:0;left:0;bottom:0;right:0;box-sizing:border-box;padding:0;border:none;margin:auto;display:block;width:0;height:0;min-width:100%;max-width:100%;min-height:100%;max-height:100%"/>
                        </div>
                    </a>
                    <nav class="headerMenu flex w-full relative hidden lg:flex md:ms-6 xl:ms-10">

                        <?php $__currentLoopData = topCategories(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="menuItem group cursor-pointer py-7 relative">
                                <a class="inline-flex items-center text-sm xl:text-base text-heading px-3 xl:px-4 py-2 font-normal relative group-hover:text-black" href=""><?php echo e($c->title); ?>
                                    ...
                                    <?php if($c->type_id == 1): ?>
                                        <div class="subMenu shadow-header bg-gray-200 absolute start-0 opacity-0 group-hover:opacity-100">
                                            <ul class="text-body text-sm py-5">
                                                <?php $__currentLoopData = $c->getSubCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li class="relative">
                                                        <a class="flex items-center justify-between py-2 ps-5 xl:ps-7 pe-3 xl:pe-3.5 hover:text-heading hover:bg-gray-300" href=""><?php echo e($c2->title); ?></a>
                                                    </li>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </ul>
                                        </div>
                                    <?php elseif($c->type_id == 2): ?>
                                        <div class="megaMenu shadow-header bg-gray-200 absolute -start-20 xl:start-0 opacity-0 invisible group-hover:opacity-100 group-hover:visible">
                                            <div class="grid grid-cols-<?php echo e(count($c->getSubCategories)); ?>">

                                                <?php $__currentLoopData = $c->getSubCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <ul class="even:bg-gray-150 pb-7 2xl:pb-8 pt-6 2xl:pt-7">
                                                        <li class="mb-1.5">
                                                            <a class="block text-sm py-1.5 text-heading font-semibold px-5 xl:px-8 2xl:px-10 hover:text-heading hover:bg-gray-300" href=""><?php echo e($c2->title); ?></a>
                                                        </li>
                                                        <?php $__currentLoopData = $c2->getSubCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c3): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li class="">
                                                                <a class="text-body text-sm block py-1.5 px-5 xl:px-8 2xl:px-10 hover:text-heading hover:bg-gray-300" href=""><?php echo e($c3->title); ?></a>
                                                            </li>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </ul>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /Users/emrekaradag/Desktop/projeler/desktop/LRVLPROJECT/ecommerce/resources/views/front/layout.blade.php ENDPATH**/ ?>
<?php $__env->startSection("content"); ?>
    ...
    <div class="modal fade" id="brandModal" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <form method="post" action="<?php echo e(route("admin.brand.store")); ?>" class="form modal-content">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make("back.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\MONSTER\Desktop\LRVLPROJECT\ecommerce\resources\views/back/brand/index.blade.php ENDPATH**/ ?>
<?php $__env->startSection("content"); ?>
    <div class="main-content">
        <div class="breadcrumb d-flex align-items-center justify-content-between">
            <h1>Kullanıcılar</h1>
            <a href="<?php echo e(route("admin.users.create")); ?>" class="btn btn-primary btn-rounded">Kullanıcı Ekle</a>
        </div>
        ...
        <section class="ul-contact-page">
            <div class="row">
                ...
                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        $d->deleteRoute = route("admin.users.destroy",$d->id);
                    ?>
                                ...
                                <div class="ul-contact-page__profile">
                                    ...
                                    <div class="ul-contact-page__info">
                                        ...
                                        <div class="text-muted mt-3 text-right">
                                            <a href="<?php echo e(route("admin.users.edit",$d->id)); ?>" class="btn btn-xs btn-xxs px-3 py-2 btn-facebook"><i class="nav-icon i-Pen-2"></i></a>
